...
const Sectionone = () => {
  ...
  return (
    <div className="section-img relative mb-8">
      <div
        data-aos="fade-left"
        className="flex text-center w-[90%] space-y-4 md:w-2/3 mx-auto my-auto h-full flex-col justify-center items-center text-white z-10 overflow-hidden">
